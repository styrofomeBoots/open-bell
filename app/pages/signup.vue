    ...
    <BaseCard class="mx-auto max-w-lg min-w-sm">
      ...
      <form class="mt-8 space-y-5" @submit.prevent="submit">
        ...
        <div class="form-control w-full mb-[0.75rem]">
          <div class="relative">
            <label class="floating-label form-control w-full">
              <input v-model="form.password" :type="showPassword ? 'text' : 'password'"
                class="input input-bordered w-full pr-12" placeholder="Password" required minlength="8" />
          ...
          <p class="label text-base-content/60 text-xs ml-1">Minimum 8 characters</p>
        </div>
          ...
          <div class="relative">
            <label class="floating-label form-control w-full">
              <input v-model="form.confirmPassword" :type="showPassword ? 'text' : 'password'"
                class="input input-bordered w-full" placeholder="Confirm password" minlength="8" required />
              <span class="label-text">Confirm password</span>
            </label>
          </div>

          <p class="label text-xs ml-1" :class="form.password &&
        ...
        <div>
          <button type="submit" class="btn btn-primary w-full" :disabled="!canSubmit || isSubmitting">
        ...
        <div class="text-center text-sm text-base-content/70">
          ...
          <NuxtLink class="link link-primary font-medium" to="/login">Log in</NuxtLink>
        </div>
      </form>
    </BaseCard>
  </div>
